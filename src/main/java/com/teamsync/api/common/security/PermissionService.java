...
public class PermissionService {
  ...
  public void requireProjectManagementPermission(OrganizationMember member) {
  ...
  public void requireOrganizationManagementPermission(OrganizationMember member) {
  ...
  public void requireTaskCreationPermission(OrganizationMember member) {
  ...
  public void requireTaskUpdatePermission(OrganizationMember member) {
  ...
  public void requireMemberManagementPermission(OrganizationMember member) {
  ...
  public void requireRoleUpdatePermission(OrganizationMember currentMember, OrganizationMember targetMember, OrganizationRole newRole) {
    ...
    if (currentRole == OrganizationRole.ADMIN && targetRole == OrganizationRole.ADMIN) {
      throw new ForbiddenException(
  ...
  public void requireMemberRemovalPermission(OrganizationMember currentMember, OrganizationMember targetMember) {
